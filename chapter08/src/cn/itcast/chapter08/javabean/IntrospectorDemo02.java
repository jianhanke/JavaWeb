...
//		System.out.println(p);
		...
		Person2 p=new Person2();
		PropertyDescriptor prot=new PropertyDescriptor("name",p.getClass());
		Method md=prot.getWriteMethod();
		md.invoke(p,"小明");
		System.out.println(p);
		PropertyDescriptor prot2=new PropertyDescriptor("age",p.getClass());
		Method md2=prot2.getWriteMethod();
		md2.invoke(p, 23);
		System.out.println(p);
	}
